# Evidence-First Workflow Specification

## Purpose

Define the optional `evidence-first` OpenSpec schema and its expected adoption,
validation, and documentation behavior for repositories that need stronger
